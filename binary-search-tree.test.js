...
fdescribe("insertRecursively", function() {
  it("inserts a node at the correct position", function() {
    var binarySearchTree = new BinarySearchTree();
    binarySearchTree
...
fdescribe("findRecursively", function() {
  it("finds a node correctly", function() {
    let binarySearchTree = new BinarySearchTree();
    binarySearchTree
      .insert(15)
...
fdescribe("dfsPreOrder", function() {
...
fdescribe("dfsPostOrder", function() {
